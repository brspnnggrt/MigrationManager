...
IW.Reactors.SelectBox = React.createClass({ displayName: 'exports',
  ...
  render: function () {
    ...
    return IW.Reactors.SelectBox.div({
      ...
      tabIndex: '0',
      'aria-hidden': true
    }, IW.Reactors.SelectBox.div({ className: 'react-select-box-label' }, this.label())), this.renderOptionMenu(), this.renderClearButton(), this.renderNativeSelect());
  },
  ...
  renderNativeSelect: function () {
    ...
    return IW.Reactors.SelectBox.div({ className: 'react-select-box-native' }, IW.Reactors.SelectBox.label({ htmlFor: id }, this.props.label), IW.Reactors.SelectBox.select({
      id: id,
      multiple: multiple,
